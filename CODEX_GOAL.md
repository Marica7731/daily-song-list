...
- 当前下一步（2026-08-25 04:19）：完成上述全量 next-serving/relay/storage/release/compile/diff，commit/push/PR/CI/squash merge；重新读取 latest main/accepted、实际 writer/relay 与固定卷/cgroup/宿主/relay 门禁，确认零并发 writer、零实际重复 WDC 后只调度一次 latest-head WDC。新 run 必须通过 `00e65040921c60a9=283/1/283/283`、`10df4dffdbdef345=189/1/188/189`、`0007036316d9dffa=771/1/737` 与全部历史 target，随后完成 bundle/deploy、公网 API/浏览器、10 分钟观察和 exact cleanup；任何失败继续从完整 checkpoint/异常做最小修复，禁止盲重跑。
