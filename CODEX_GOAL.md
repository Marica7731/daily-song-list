...
- `in_progress`：run `32451093545` 的 Artist owner 晚失败已在隔离 worktree 完成源码、生产形态回归与全 revision 前置门禁；完整 next-serving `196/196` 与 relay `5/5` 已通过，PR/CI/squash merge前禁止重跑。
