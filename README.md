...
2. It fetches each candidate watch page, extracts description and first comment continuations, parses timestamped song lists, and skips videos without usable songs.
   ...
   - Existing snapshots also pass through a front-end in-memory safety filter for high-confidence unknown-artist section markers such as waiting/ending notes and for obvious ordinal title prefixes like `01|`, `10曲目`, or `3 01.`.
