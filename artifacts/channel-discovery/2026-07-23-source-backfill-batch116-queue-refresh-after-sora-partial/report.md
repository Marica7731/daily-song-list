# Source Backfill Batch116 Queue Refresh After SoraOtoha Partial

- Status: audit_only
- Scope: update batch114 queue with batch115 SoraOtoha partial checkpoint accepted increment; no YouTube fetch; no data/external write.
- Source count: 13
- Unresolved count excluding partial-artifact-ready follow-up: 5
- Partial artifact-ready sources whose full source remains pending: 3
- Accepted totals represented by existing ready/partial artifacts: videos=400, occurrences=5424, songs=4999
...
| SoraOtoha | partial_artifact_ready | 10 | 200 | 200 | artifacts/channel-discovery/2026-07-23-source-backfill-batch115-soraotoha-partial-checkpoint/manifest.json | full source remains pending; this batch exports only completed checkpoint details |
...
- ebakyouka: accepted 18 videos / 455 occurrences; full source still pending or partial by source scope.
- KohanaLam: accepted 2 videos / 13 occurrences; full source still pending or partial by source scope.
- SoraOtoha: accepted 10 videos / 200 occurrences; full source still pending or partial by source scope.
