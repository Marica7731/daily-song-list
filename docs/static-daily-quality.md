...
- A timestamped stream announcement with a weekday wrongly parsed as its artist.
...
A baseline spot check of September 19-25 source shards found 173 highly
suspicious occurrences out of 7,787: 172 rosary-broadcast timestamps and one
dated streaming announcement. This is a sample, **not** the total-site count.
