...
function isConversationEntry(song) {
  ...
  if (/(?:背景を変える|横に置く|食べる|飲む|お名前呼び|配信告知|チャンネル登録|スパチャ|メンシ|スクショ|サムネ|写真|告知|登録|コメント|ギフト|リクエスト|メンバー|キャンペーン|アルバム発売記念|おすすめ.*(?:集|紹介)|曲紹介|歌うフリ|姉|妹|幼馴染|指が細い|身長が低い|家族に例える|ペットショップ|ラー油|ケンタッキー|バーガーキング|酒のラベル|春が嫌い|カンニング|再確認|覚えてきた曲|ごらんください|ご覧ください)/iu.test(value)) return true;
