...
test("artist canonicalization keeps official names for common variants", () => {
  const { records } = buildArtistRecords([
    ...
    occurrence("StaRt", "Mrs.GREEN APPLE", "mrs-a"),
    occurrence("点描の唄", "Mr.s Green Apple", "mrs-b"),
    occurrence("天体観測", "bumpofchicken", "bump-a"),
    occurrence("カルマ", "BUMP OF CHICKEN", "bump-b"),
    occurrence("アイドル", "yoasobi", "yoasobi-a"),
    occurrence("夜に駆ける", "YOASOBI", "yoasobi-b"),
    occurrence("紅蓮華", "lisa", "lisa-a"),
    occurrence("炎", "LiSA", "lisa-b"),
    occurrence("からくりピエロ", "40mp", "40mp-a"),
    occurrence("恋愛裁判", "40mP", "40mp-b"),
    occurrence("少女レイ", "みきとＰ", "mikito-a"),
    occurrence("いーあるふぁんくらぶ", "MikitoP", "mikito-b"),
    occurrence("晩餐歌", "tuki", "tuki-a"),
    occurrence("晩餐歌 (Bansanka)", "tuki.", "tuki-b"),
    occurrence("スパークル", "radwimps", "rad-a"),
    occurrence("前前前世", "RADWIMPS", "rad-b"),
    occurrence("HOT LIMIT", "T.M. Revolution", "tmr-a"),
    occurrence("WHITE BREATH", "tmrevolution", "tmr-b"),
  ]);
